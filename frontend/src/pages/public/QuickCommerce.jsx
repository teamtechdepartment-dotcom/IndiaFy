          ...
          >
            <div className="p-4 border-b border-zinc-100 flex items-center justify-between">
              <div>
                ...
                <p className="text-[10px] font-bold text-emerald-500 uppercase tracking-wide">under 30 min delivery</p>
              </div>
...
export default function QuickCommerce() {
  ...
  return (
    <div className="bg-[#f2f4f7] min-h-screen flex flex-col font-sans pb-16 md:pb-0">
      <SEOHead 
        title="Under 30 Minute Delivery in Gurugram | Indiafy Quick Commerce"
