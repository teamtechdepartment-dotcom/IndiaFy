        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          <div className="w-full lg:w-3/4 max-w-3xl prose prose-slate prose-headings:font-black prose-headings:tracking-tight prose-a:text-brand-primary">
            ...
            <section id="consent" className="mb-16 scroll-mt-32">
              ...
              <ul>
                <li><strong>Explicit Affirmative Consent (No Auto-Tick):</strong> In compliance with Section 6 of the DPDP Act, 2023 and CCPA Dark Patterns Guidelines, Indiafy strictly prohibits pre-ticked checkboxes, auto-selected opt-ins, or implied default consent. We obtain clear, affirmative, un-checked opt-in consent at the time of account registration and transaction checkout. You are presented with a clear notice detailing what data is collected, the purpose, and your rights — as required under <strong>Section 5 of the DPDP Act</strong>.</li>
