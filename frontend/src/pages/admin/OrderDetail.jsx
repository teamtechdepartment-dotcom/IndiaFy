...
export default function OrderDetails() {
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen" style={{background:"radial-gradient(ellipse at 20% 50%, rgba(40,116,240,0.06) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(251,100,27,0.04) 0%, transparent 60%), linear-gradient(135deg, #050811 0%, #080C1A 50%, #050811 100%)"}}>
        <Sidebar />
  ...
  return (
    <div className="flex min-h-screen w-full overflow-x-hidden" style={{background:"radial-gradient(ellipse at 20% 50%, rgba(40,116,240,0.06) 0%, transparent 60%), radial-gradient(ellipse at 80% 20%, rgba(251,100,27,0.04) 0%, transparent 60%), linear-gradient(135deg, #050811 0%, #080C1A 50%, #050811 100%)"}}>
      <Sidebar />
              ...
              <div className="bg-white border rounded-3xl p-6 shadow-xs">
                    ...
                    <div key={idx} className="flex justify-between items-center py-4 first:pt-0 last:pb-0">
                      <div className="flex gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs" style={{color:"#475569"}}>Seller: {item.seller}</p>
                        </div>
                      </div>
                      <div className="text-right">
                        <p className="text-xs text-gray-500">Qty: {item.quantity}</p>
                        <p className="font-black text-gray-900">₹{Number(item?.price ?? 0).toLocaleString()}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                <div className="mt-6 border-t pt-4 space-y-2 text-xs">
                  <div className="flex justify-between">
                    ...
                    <span className="font-semibold text-slate-800">₹{Number(order?.itemsPrice ?? 0).toLocaleString()}</span>
                  </div>
                  <div className="flex justify-between">
