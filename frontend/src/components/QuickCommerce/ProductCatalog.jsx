...
const PRODUCTS_DB = {
  dairy: [
    { id: 101, name: "Amul Taaza Toned Fresh Milk", weight: "500 ml", price: 27, mrp: 27, eta: "under 30 min", store: "Organic Roots", img: "https://images.unsplash.com/photo-1563636619-e9143da7973b?w=400&q=80", badge: "fast" },
    { id: 102, name: "Britannia 100% Whole Wheat Bread", weight: "400 g", price: 50, mrp: 55, discount: "9% OFF", eta: "under 30 min", store: "Daily Mart", img: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&q=80", badge: "trending" },
    { id: 103, name: "Amul Salted Butter", weight: "100 g", price: 48, mrp: 60, discount: "20% OFF", eta: "under 30 min", store: "Fresh Hub", img: "https://images.unsplash.com/photo-1486297678162-eb2a19b0a32d?w=400&q=80" },
    { id: 104, name: "Mother Dairy Paneer", weight: "200 g", price: 85, mrp: 90, discount: "5% OFF", eta: "under 30 min", store: "Organic Roots", img: "https://images.unsplash.com/photo-1559561853-08451507cbe7?w=400&q=80", badge: "bestseller" },
  ],
  vegetables: [
    { id: 201, name: "Fresh Farm Onion", weight: "1 kg", price: 35, mrp: 45, discount: "22% OFF", eta: "under 30 min", store: "Subzi Mandi", img: "https://images.unsplash.com/photo-1620574387735-3624d75b2dbc?w=400&q=80", badge: "trending" },
    { id: 202, name: "Green Capsicum", weight: "250 g", price: 30, mrp: 35, discount: "14% OFF", eta: "under 30 min", store: "Fresh Hub", img: "https://images.unsplash.com/photo-1563565375-f3fdfdbefa83?w=400&q=80" },
    { id: 203, name: "Fresh Tomatoes", weight: "500 g", price: 25, mrp: 30, discount: "17% OFF", eta: "under 30 min", store: "Subzi Mandi", img: "https://images.unsplash.com/photo-1546470427-0d4db154ceb8?w=400&q=80", badge: "fast" },
    { id: 204, name: "Potato", weight: "1 kg", price: 28, mrp: 32, discount: "12% OFF", eta: "under 30 min", store: "Daily Mart", img: "https://images.unsplash.com/photo-1518977676601-b53f82ber40?w=400&q=80" },
  ],
  fruits: [
    { id: 301, name: "Nagpur Oranges", weight: "500 g", price: 80, mrp: 100, discount: "20% OFF", eta: "under 30 min", store: "Fruit Basket", img: "https://images.unsplash.com/photo-1611080661265-d04b86bb3d58?w=400&q=80", badge: "bestseller" },
    { id: 302, name: "Fresh Banana", weight: "6 pcs", price: 35, mrp: 40, discount: "12% OFF", eta: "under 30 min", store: "Organic Roots", img: "https://images.unsplash.com/photo-1571771894821-ce9b6c11b08e?w=400&q=80", badge: "fast" },
    { id: 303, name: "Shimla Apple", weight: "500 g", price: 120, mrp: 150, discount: "20% OFF", eta: "under 30 min", store: "Fruit Basket", img: "https://images.unsplash.com/photo-1560806887-1e4cd0b6cbd6?w=400&q=80" },
  ],
  pharma: [
  ...
  bakery: [
    { id: 501, name: "Chocolate Croissant", weight: "2 pcs", price: 90, mrp: 110, discount: "18% OFF", eta: "under 30 min", store: "Baker's Street", img: "https://images.unsplash.com/photo-1555507036-ab1f4038024a?w=400&q=80", badge: "trending" },
    { id: 502, name: "Multigrain Bread", weight: "400 g", price: 55, mrp: 65, discount: "15% OFF", eta: "under 30 min", store: "Baker's Street", img: "https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400&q=80" },
  ],
  drinks: [
    { id: 601, name: "Coca-Cola Original", weight: "750 ml", price: 40, mrp: 45, discount: "11% OFF", eta: "under 30 min", store: "Daily Mart", img: "https://images.unsplash.com/photo-1622483767028-3f66f32aef97?w=400&q=80", badge: "trending" },
    { id: 602, name: "Red Bull Energy Drink", weight: "250 ml", price: 99, mrp: 125, discount: "21% OFF", eta: "under 30 min", store: "Fresh Hub", img: "https://images.unsplash.com/photo-1568227451296-17631cc1fa23?w=400&q=80" },
    { id: 603, name: "Paper Boat Aam Panna", weight: "200 ml", price: 30, mrp: 30, eta: "under 30 min", store: "Organic Roots", img: "https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=400&q=80", badge: "fast" },
  ],
  snacks: [
    { id: 701, name: "Lay's Magic Masala", weight: "50 g", price: 20, mrp: 20, eta: "under 30 min", store: "Daily Mart", img: "https://images.unsplash.com/photo-1566478989037-e924e0e4b77d?w=400&q=80" },
    { id: 702, name: "Kurkure Masala Munch", weight: "90 g", price: 30, mrp: 30, eta: "under 30 min", store: "Fresh Hub", img: "https://images.unsplash.com/photo-1621506289937-a8e4df240d0b?w=400&q=80", badge: "bestseller" },
    { id: 703, name: "Haldiram's Bhujia Sev", weight: "200 g", price: 60, mrp: 65, discount: "8% OFF", eta: "under 30 min", store: "Daily Mart", img: "https://images.unsplash.com/photo-1599490659213-e2b9527bd087?w=400&q=80" },
  ],
  daily: [
    { id: 801, name: "Tata Salt", weight: "1 kg", price: 28, mrp: 28, eta: "under 30 min", store: "Daily Mart", img: "https://images.unsplash.com/photo-1518110925495-5fe2c8e2a76c?w=400&q=80" },
    { id: 802, name: "Fortune Sunflower Oil", weight: "1 L", price: 165, mrp: 180, discount: "8% OFF", eta: "under 30 min", store: "Fresh Hub", img: "https://images.unsplash.com/photo-1474979266404-7eaacbcd87c5?w=400&q=80", badge: "bestseller" },
    { id: 803, name: "India Gate Basmati Rice", weight: "1 kg", price: 95, mrp: 110, discount: "14% OFF", eta: "under 30 min", store: "Daily Mart", img: "https://images.unsplash.com/photo-1586201375761-83865001e31c?w=400&q=80", badge: "trending" },
  ],
};
