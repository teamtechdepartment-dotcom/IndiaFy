        ...
        <div className="animate-smooth-bg border-b border-white/10 w-full">
          <div className="max-w-[1440px] mx-auto px-4 h-14 flex items-center justify-between gap-3 relative">
            ...
            >
              ...
              <span className="text-[11px] font-extrabold text-white whitespace-nowrap">under 30 min</span>
            </motion.div>
        ...
        {locationOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 md:inset-0 md:m-auto w-full md:w-[460px] bg-white z-[101] rounded-t-3xl md:rounded-2xl shadow-2xl md:border md:border-zinc-200 flex flex-col overflow-hidden h-[92dvh] md:h-[650px] md:max-h-[90vh]"
            >
