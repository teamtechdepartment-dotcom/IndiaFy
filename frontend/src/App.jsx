        ...
        <Suspense fallback={<PageLoader />}>
          ...
          <Route element={<MarketplaceGuard />}>
            ...
            <Route element={<WebsiteLayout />}>
              ...
              {/* /checkout & /payment protected — moved to customer auth block below */}
            ...
            <Route element={<ProtectedRoute allowedRoles={["customer"]} />}>
              ...
              {/* ===================================================
                  CHECKOUT (protected – require customer login)
              =================================================== */}
              <Route path="/checkout" element={<Checkoutpage />} />
              <Route path="/payment" element={<Paymentpage />} />
              {/* Alias sub-routes to main checkout */}
              <Route path="/cart/checkout" element={<Navigate to="/checkout" replace />} />
              ...
              <Route path="/orders/place" element={<Navigate to="/checkout" replace />} />
            </Route>
          ...
          <Route element={<ProtectedRoute allowedRoles={["seller"]} />}>
            ...
            <Route path="/seller/application-status/:nodeType" element={<ApplicationStatus />} />
